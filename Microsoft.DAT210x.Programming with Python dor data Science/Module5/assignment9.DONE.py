...
#
# .. your code here ..
df = pd.read_csv('Datasets/College.csv',header=0,delimiter=',',index_col=0)
...
drawLine(model, X_train, y_train, "Accept(Room&Board) train", score)
drawLine(model, X_test, y_test, "Accept(Room&Board) test", score)
...
drawLine(model, X_train, y_train, "Accept(Enroll) train", score)
drawLine(model, X_test, y_test, "Accept(Enroll) test", score)
...
drawLine(model, X_train, y_train, "Accept(F.Undergrad) train", score)
drawLine(model, X_test, y_test, "Accept(F.Undergrad) test", score)
...
drawPlane(model, X_train, y_train, "Accept(Room&Board,Enroll) train", score)
drawPlane(model, X_test, y_test, "Accept(Room&Board,Enroll) test", score)
