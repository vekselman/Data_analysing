...
#glob.glob('Datasets/recordings/0_jackson[0-49].wav')
for i in range(0,50):
    path = 'Datasets/recordings/0_jackson_' + str(i) + '.wav'
    zero.append(wavfile.read(path)[1])
...
#
# .. your code here ..
n_samples, n_audio_samples = df.shape
