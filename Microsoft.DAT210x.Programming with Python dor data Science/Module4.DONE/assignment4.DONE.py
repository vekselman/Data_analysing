...
T_pca = pca.fit_transform(df)
print(pca.components_[0,:])
print(T_pca)
#Plot2D(T_pca,'PCA 2 components',1,2)
#Plot3D(T_pca,'PCA 3 components',0,1,2)
#
...
Plot2D(T_iso,'IsoMap 2 components {0} neigbors'.format(iso.n_neighbors),0,1)
Plot2D(T_iso,'IsoMap 2 components {0} neigbors'.format(iso.n_neighbors),1,2)
Plot3D(T_iso,'IsoMap 3 components {0} neigbors'.format(iso.n_neighbors),0,1,2)
#
